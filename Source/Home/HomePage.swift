    ...
    private var myCard: some View {
        HStack(alignment: .center) {
            Image("selfie")
                ...
                .cornerRadius(8)
            Text("Меня зовут Дмитрий Гулягин, и уже больше 5 лет я занимаюсь iOS-разработкой. В этом блоге я расcказываю о своих pet-проектах и пишу технические статьи про iOS, SwiftUI и Metal шейдеры. Обратная связь - <a href='https://t.me/roxot'>@Roxot</a>, буду рад вашему фидбеку 🙂.")
        }
        .frame(width: 600)
        .padding()
