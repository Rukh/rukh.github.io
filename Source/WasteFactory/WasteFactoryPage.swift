    ...
    public var body: some View {
        GlobalView(currentPage: .wasteFactory) {
            VStack(alignment: .leading) {
                ...
                Text("Waste Factory – это игра про переработку мусора. НА начальном этапе доступна лишь сортировка, и то в ручном режиме. При получении валюты открываются новые улучшения, в том числе и автаматическое оборудование для фабрики.")
